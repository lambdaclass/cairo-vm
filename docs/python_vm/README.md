...
A `ReferenceManager` contains a list of `Reference`, and the methods to add a reference and return its position (`alloc_id`), and to get a reference by its position (`get_ref`)
