.PHONY: deps build run check test clippy coverage benchmark flamegraph compare_benchmarks_deps compare_benchmarks docs clean compare_vm_output cairo_trace cairo-rs_trace cairo_bench_programs cairo_proof_programs cairo_test_programs
