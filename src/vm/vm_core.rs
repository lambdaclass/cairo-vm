...
mod tests {
    ...
    fn test_step_for_preset_memory() {
        ...
        vm.memory.insert(
            &MaybeRelocatable::from((0, 0)),
            &MaybeRelocatable::Int(bigint64!(2345108766317314046)),
        );
        vm.memory.insert(
    ...
    */
    fn test_step_for_preset_memory_function_call() {
        ...
        vm.memory.insert(
            &MaybeRelocatable::from((0, 0)),
            &MaybeRelocatable::Int(bigint64!(5207990763031199744)),
        );
        vm.memory.insert(
            &MaybeRelocatable::from((0, 1)),
        ...
        vm.memory.insert(
            ...
            &MaybeRelocatable::Int(bigint64!(5189976364521848832)),
        );
        vm.memory.insert(
        ...
        vm.memory.insert(
            ...
            &MaybeRelocatable::Int(bigint64!(1226245742482522112)),
        );
        vm.memory.insert(
