...
pub fn assert_le_felt(
    ...
    insert_integer_from_var_name("small_inputs", value, ids, vm_proxy, hint_ap_tracking)
}
...
pub fn split_int(
    ...
    vm_proxy.memory.insert_integer(&output, res)
}
...
pub fn is_positive(
    ...
    insert_integer_from_var_name("is_positive", result, ids, vm_proxy, hint_ap_tracking)
}
...
pub fn split_felt(
    ...
    insert_integer_from_var_name("high", high, ids, vm_proxy, hint_ap_tracking)?;
...
pub fn sqrt(
    ...
    insert_integer_from_var_name("root", isqrt(&mod_value)?, ids, vm_proxy, hint_ap_tracking)
}
...
pub fn signed_div_rem(
    ...
    insert_integer_from_var_name("r", r, ids, vm_proxy, hint_ap_tracking)?;
    insert_integer_from_var_name("biased_q", biased_q, ids, vm_proxy, hint_ap_tracking)
}
...
pub fn unsigned_div_rem(
    ...
    insert_integer_from_var_name("r", r, ids, vm_proxy, hint_ap_tracking)?;
    insert_integer_from_var_name("q", q, ids, vm_proxy, hint_ap_tracking)
}
