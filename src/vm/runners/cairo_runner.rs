...
impl CairoRunner {
    ...
    pub fn add_additional_hash_builtin(&self, vm: &mut VirtualMachine) -> Relocatable {
        ...
        // initialize_segments for HashBuiltinRunner cn
        builtin.initialize_segments(&mut vm.segments).unwrap();
...
mod tests {
    ...
    fn check_memory_usage_err_case() {
        ...
        vm.builtin_runners = vec![{
            ...
            builtin_runner
                .initialize_segments(&mut vm.segments)
                .unwrap();
    ...
    fn initialize_segments_with_base() {
        ...
        cairo_runner
            .initialize_segments(&mut vm, program_base)
            .unwrap();
        assert_eq!(
    ...
    fn initialize_segments_no_base() {
        ...
        let mut vm = vm!();
        cairo_runner.initialize_builtins(&mut vm).unwrap();
        cairo_runner.initialize_segments(&mut vm, None).unwrap();
        assert_eq!(
            cairo_runner.program_base,
            Some(Relocatable {
                segment_index: 0,
    ...
    */
    ...
    fn initialize_main_entrypoint_proof_mode_empty_program() {
        ...
        let mut vm = vm!();
        runner.initialize_segments(&mut vm, None).unwrap();
    ...
    fn run_from_entrypoint_custom_program_test() {
        ...
        new_cairo_runner
            .initialize_segments(&mut new_vm, None)
            .unwrap();
