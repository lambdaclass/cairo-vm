...
pub fn qm31_packed_reduced_mul(felt1: Felt252, felt2: Felt252) -> Result<Felt252, MathError> {
    ...
    let coordinates1 = [
        coordinates1_u64[0] as u128,
        coordinates1_u64[1] as u128,
        coordinates1_u64[2] as u128,
        coordinates1_u64[3] as u128,
    ];
    let coordinates2 = [
        coordinates2_u64[0] as u128,
        coordinates2_u64[1] as u128,
    ...
    let result_unreduced_coordinates = [
        ...
        ((stwo_prime_u128 * stwo_prime_u128
            ...
            - coordinates1[3] * coordinates2[3])
            % stwo_prime_u128) as u64,
        ((2 * stwo_prime_u128 * stwo_prime_u128 + coordinates1[0] * coordinates2[2]
