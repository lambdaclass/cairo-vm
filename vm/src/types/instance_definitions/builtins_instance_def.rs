...
use super::segment_arena_instance_def::SegmentArenaInstanceDef;
use super::{
...
pub(crate) struct BuiltinsInstanceDef {
    ...
    pub(crate) segment_arena: Option<SegmentArenaInstanceDef>,
...
impl BuiltinsInstanceDef {
    ...
    pub(crate) fn starknet() -> BuiltinsInstanceDef {
        BuiltinsInstanceDef {
            ...
            segment_arena: Some(SegmentArenaInstanceDef::default()),
            range_check96: None,
            add_mod: None,
            mul_mod: None,
        }
