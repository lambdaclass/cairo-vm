...
impl CairoRunner {
    ...
    pub fn get_public_memory_offsets(&self) -> &HashMap<usize, Vec<(usize, usize)>> {
        &self.vm.segments.public_memory_offsets
    }
    ...
    pub fn get_builtins_segments(&self) -> BTreeMap<usize, BuiltinName> {
        self.vm
            .builtin_runners
            .iter()
            .filter(|builtin| !matches!(builtin, BuiltinRunner::SegmentArena(_)))
            .map(|builtin| {
...
mod tests {
    ...
    */
    ...
    #[test]
    fn test_get_public_memory_offsets() {
        let program_content =
            include_bytes!("../../../../cairo_programs/proof_programs/example_program.json");
        let runner = crate::cairo_run::cairo_run(
            program_content,
            &CairoRunConfig {
        ...
        let expected_public_memory_offsets_segment_1 = vec![(0, 0), (1, 0), (2, 0), (30, 0)];

        assert_eq!(
            public_memory_offsets[&1],
            expected_public_memory_offsets_segment_1
        );
    }

    #[test]
    fn test_get_builtins_segments() {
        let program_content =
        ...
        assert_eq!(builtins_segments[&2], BuiltinName::bitwise);
    }
    ...
    fn end_run_fill_builtins() {
        ...
        let builtin_segments = cairo_runner.get_builtins_segments();
    ...
    fn end_run_fill_middle_holes() {
        ...
        let builtins_segments = cairo_runner.get_builtins_segments();
        assert!(builtins_segments.get(&9) == Some(&BuiltinName::poseidon));
    }
}
