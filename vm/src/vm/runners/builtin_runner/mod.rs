    ...
    fn compare_proof_mode_with_and_without_disable_trace_padding() {
            ...
            .zip(builtin_runners_true.iter())
        {
            ...
            let (_, allocated_size_true) = builtin_runner_true
                ...
                .unwrap_or((0, 0));
            let allocated_instances_false = safe_div_usize(
            ...
            .unwrap();
            assert!(allocated_instances_false.is_power_of_two() || allocated_instances_false == 0);
            assert!(allocated_instances_true.is_power_of_two() || allocated_instances_true == 0);
