...
impl VirtualMachine {
    ...
    /// Returns a mutable iterator over both the builtins and simulated_builtin_runners.
    pub fn get_builtin_runners_as_mut_iter(&mut self) -> impl Iterator<Item = &mut BuiltinRunner> {
        self.builtin_runners
            .iter_mut()
    ...
    pub fn get_signature_builtin(
        ...
        for builtin in self.get_builtin_runners_as_mut_iter() {
