...
impl HintProcessorLogic for BuiltinHintProcessor {
    fn compile_hint(
            ...
            let ids_data = match hint_code {
                ...
                hint_code::SQUASH_DICT_INNER_FIRST_ITERATION =>  get_ids_data(reference_ids, references)?,
                ...
                hint_code::VERIFY_ZERO_V1 | hint_code::VERIFY_ZERO_V2 =>  get_ids_data(reference_ids, references)?,
                ...
                hint_code::NONDET_BIGINT3_V1 | hint_code::NONDET_BIGINT3_V2 =>  get_ids_data(reference_ids, references)?,
                ...
                hint_code::BLAKE2S_FINALIZE | hint_code::BLAKE2S_FINALIZE_V2 =>  get_ids_data(reference_ids, references)?,
                ...
                hint_code::SQUASH_DICT_INNER_CHECK_ACCESS_INDEX =>  get_ids_data(reference_ids, references)?,
                ...
                hint_code::SQUASH_DICT_INNER_USED_ACCESSES_ASSERT =>  get_ids_data(reference_ids, references)?,
                ...
                hint_code::UINT256_EXPANDED_UNSIGNED_DIV_REM =>  get_ids_data(reference_ids, references)?,
                hint_code::BIGINT_TO_UINT256 =>  get_ids_data(reference_ids, references)?,
                hint_code::IS_ZERO_PACK_V1 | hint_code::IS_ZERO_PACK_V2 =>  get_ids_data(reference_ids, references)?,
                ...
                hint_code::DIV_MOD_N_PACKED_DIVMOD_EXTERNAL_N =>  get_ids_data(reference_ids, references)?,
                ...
                hint_code::SHA256_MAIN_CONSTANT_INPUT_LENGTH =>  get_ids_data(reference_ids, references)?,
                hint_code::SHA256_MAIN_ARBITRARY_INPUT_LENGTH =>  get_ids_data(reference_ids, references)?,
                ...
                hint_code::RUN_P_CIRCUIT_WITH_LARGE_BATCH_SIZE =>  get_ids_data(reference_ids, references)?,
                #[cfg(feature = "test_utils")]
