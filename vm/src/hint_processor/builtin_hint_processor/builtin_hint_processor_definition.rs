...
#[cfg(feature = "print")]
use crate::hint_processor::builtin_hint_processor::print::{print_array, print_dict, print_u256};
...
impl HintProcessorLogic for BuiltinHintProcessor {
    fn execute_hint(
        ...
        match &*hint_data.code {
            ...
            #[cfg(feature = "print")]
            hint_code::PRINT_U256 => print_u256(vm, &hint_data.ids_data, &hint_data.ap_tracking),
            #[cfg(feature = "print")]
