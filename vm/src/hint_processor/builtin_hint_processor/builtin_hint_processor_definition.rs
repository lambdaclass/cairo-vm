...
impl HintProcessorLogic for BuiltinHintProcessor {
    ...
    fn compile_hint(
        ...
        let f = match hint_code {
            ...
            // hint_code::UINT256_ADD => uint256_add,
            // hint_code::UINT256_ADD_LOW => uint256_add,
            // hint_code::UINT128_ADD => uint128_add,
            // hint_code::UINT256_SUB => uint256_sub,
            // hint_code::SPLIT_64 => split_64,
            // hint_code::UINT256_SQRT => uint256_sqrt,
            // hint_code::UINT256_SQRT_FELT => uint256_sqrt,
            ...
            // hint_code::DIV_MOD_N_SAFE_DIV => div_mod_n_safe_div,
            // hint_code::DIV_MOD_N_SAFE_DIV_PLUS_ONE => div_mod_n_safe_div,
            ...
            // hint_code::SPLIT_OUTPUT_0 => split_output,
            // hint_code::SPLIT_OUTPUT_1 => split_output,
            // hint_code::SPLIT_INPUT_3 => split_input,
            // hint_code::SPLIT_INPUT_6 => split_input,
            // hint_code::SPLIT_INPUT_9 => split_input,
            // hint_code::SPLIT_INPUT_12 => split_input,
            // hint_code::SPLIT_INPUT_15 => split_input,
            ...
            // hint_code::NONDET_ELEMENTS_OVER_TEN => elements_over_x,
            // hint_code::NONDET_ELEMENTS_OVER_TWO => elements_over_x,
            ...
            // hint_code::XS_SAFE_DIV => div_mod_n_safe_div,
