...
impl Cairo1HintProcessor {
    ...
    fn uint256_div_mod(
        ...
        let dividend_low = res_operand_get_val(vm, dividend0)?.to_biguint();
        let dividend_high = res_operand_get_val(vm, dividend1)?.to_biguint();
        let divisor_low = res_operand_get_val(vm, divisor0)?.to_biguint();
        let divisor_high = res_operand_get_val(vm, divisor1)?.to_biguint();
        ...
        let (_, limb) = quotient.div_rem(&pow_2_64);
