...
echo -e "\nPython Original Cairo VM builtins integration time:" >> results
...
echo -e "\nPyPy Original Cairo VM  builtins integration time:" >> results
...
echo -e "\nPyPy Original Cairo VM compare arrays time:" >> results
